...
genofile = "FAKE.fasta.gz"# "GCF_001704415.1_ARS1_genomic.fa.gz" # "ryegrass.fa.gz"

## step 2. population structure
numFounders = 100; # number of founders in the base population
endSize = 5000; # number of individuals to end up in the changingPopSize step
numInd = 960; # number of individuals to be simulated (default = 96)
...
muDensity = 0.01 # 0.01 # expected gloabl SNP density
...
seqDepth = 100 # expected sequencing depth
